...
features:
  - title: "Vì sao chọn Từ Lâu?"
    ...
    workshops:
      - title: "Vẽ & Tô màu"
        image: "/images/workshop-watercolor.jpg"
        description: "Thỏa sức sáng tạo với màu nước, vẽ tranh trên vải và giấy. Từ cơ bản đến nâng cao, phù hợp mọi độ tuổi."
      - title: "Thêu & Đan móc"
        image: "/images/workshop-embroidery.jpg"
        description: "Tạo ra những món phụ kiện handmade độc đáo. Học kỹ thuật thêu hiện đại và đan móc cơ bản."
      - title: "Làm nến thơm"
        image: "/images/workshop-candle.jpg"
        description: "Pha chế hương thơm riêng và tạo hình nến theo ý thích. Workshop thư giãn và đầy cảm hứng."
    bulletpoints:
